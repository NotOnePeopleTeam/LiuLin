...
import { shareBind } from '../../../api/user.js';
const app = getApp();
...
Page({
  ...
  */
  goCat: function () {
    // wx.navigateTo({
    //   url: '/pages/activity/goods_bargain_details/index',
    // })
  ...
  onLoadFun:function(e){
    ...
    shareBind({spread: this.data.spid, uid: this.data.userInfo.uid}).then(res => {
      console.log(res);
    })
  },
  /**
