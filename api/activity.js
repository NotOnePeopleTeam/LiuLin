 ...
 * @param object data
 */
export function storeListMap(data) {
  return request.get('store_list_map', data);
}
 ...
 * 
 */
export function drawPrice(data) {
  return request.get('draw/prize', data)
}
/**
 * 确认获奖
 * @param object data
 * 
 */
export function drawLucky(data) {
  return request.post('draw/choujiang', data)
}
/**
 * 中奖记录
 * @param object data
 * 
 */
export function zhongLuckly(data) {
  return request.get('draw/logs', data)
}